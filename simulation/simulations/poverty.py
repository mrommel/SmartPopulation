...
class PovertySimulation(SimulationBase):
	...
	def __init__(self):
		...
		# connections:
		self.effects.append(SimulationConnection('poor_mood', '0.3 - (x ** 2)'))  # Poor_mood,0.3-(x^2)
		self.effects.append(SimulationConnection('crime_rate', '0.41 * (x ** 2.0)', 4))  # CrimeRate,0.41*(x^2),4
